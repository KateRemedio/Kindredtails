import svgPaths from "./svg-c1hplf28oy";
import imgImageTanya from "./284b1b3d871b64632e8c63914ee857d9b7c34a23.png";
import imgImageTanya1 from "./26cb0f7139e8b9fa0a8d82df7245f2a7baa04d2d.png";
import imgImageTanya2 from "./9c98017f916f33bd226293f66520a00e38af9aac.png";
...
function ButtonZoomOut1() {
  return (
    <div className="bg-[#f4f4f4] relative rounded-bl-[2px] rounded-br-[2px] shrink-0 size-[30px]" data-name="Button - Zoom out">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Monaco:Bold',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#bbb] text-[22px] text-center whitespace-nowrap">−</p>
      </div>
    </div>
  );
}
...
function ImageTanya() {
  return (
    <div className="relative rounded-[12.22px] shrink-0 size-[142.88px]" data-name="Image (Tanya)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[12.22px] size-full" src={imgImageTanya} />
    </div>
  );
}
...
function Container41() {
  return (
    <div className="bg-[#e5e7eb] relative rounded-[15.04px] shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start p-[3.76px] relative size-full">
        <ImageTanya />
      </div>
    </div>
  );
...
function Container40() {
  return (
    <div className="content-stretch flex flex-col items-start relative w-[150.4px]" data-name="Container">
      <Container41 />
    </div>
  );
}

function ImageTanya1() {
  return (
    <div className="relative rounded-[12.22px] shrink-0 size-[142.88px]" data-name="Image (Tanya)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[12.22px] size-full" src={imgImageTanya1} />
    </div>
  );
}
...
function ImageTanya2() {
  return (
    <div className="relative rounded-[13px] shrink-0 size-[152px]" data-name="Image (Tanya)">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[13px] size-full" src={imgImageTanya2} />
    </div>
  );
}
...
function Container44() {
  return (
    <div className="absolute bg-[#2a6b4a] content-stretch flex flex-col items-start left-[106.01px] p-[4px] rounded-[16px] top-[-0.01px] w-[160px]" data-name="Container">
      <ImageTanya2 />
    </div>
  );
}
...
function Container39() {
  return (
    <div className="h-[175px] relative shrink-0 w-[372.014px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="absolute flex items-center justify-center left-[106.97px] size-[158.065px] top-[0.96px]">
          <div className="-rotate-3 flex-none">
            <Container40 />
          </div>
        </div>
        <div className="absolute flex items-center justify-center left-[105.74px] size-[160.525px] top-[-0.27px]">
...
function Button5() {
  return <div className="bg-[#2a6b4a] h-[5.998px] relative rounded-[3px] shrink-0 w-[20px]" data-name="Button" />;
}

function Button6() {
  return <div className="bg-[#e5e7eb] relative rounded-[3px] shrink-0 size-[5.998px]" data-name="Button" />;
}
...
function Container45() {
  return (
    <div className="h-[17.998px] relative shrink-0 w-[372.014px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-start justify-center pt-[12px] relative size-full">
        <Button5 />
        <Button6 />
        <Button7 />
      </div>
...
function Heading() {
  return (
    <div className="relative shrink-0 w-full" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[33px] not-italic relative shrink-0 text-[#111827] text-[22px] text-center whitespace-nowrap">Tanya</p>
      </div>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[372.014px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center pt-[4px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#9ca3af] text-[13px] text-center whitespace-nowrap">🐕 dog · German Shepherd · Cebu City, Philippines</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[21px] relative shrink-0 w-[372.014px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center pt-[3px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#9ca3af] text-[12px] text-center whitespace-nowrap">🕰 13 years · 🕊 June 3, 2026</p>
      </div>
    </div>
  );
}
...
function Container46() {
  return (
    <div className="h-[88px] relative shrink-0 w-[372.014px]" data-name="Container">
...
function Container47() {
  return (
    <div className="bg-[#faf8f5] h-[180px] max-h-[180px] relative rounded-[14px] shrink-0 w-[372.014px]" data-name="Container">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[22.1px] left-[16.55px] not-italic text-[#374151] text-[13px] top-[15.89px] w-[339px]">{`Tanya was our little princess. She spent her days in the coolest spot in mom's upstairs garden, watching the neighbours pass by like it was her own little show. She loved hiking with mom and the other dogs, and would stomp her foot and give you the most dramatic cartoon puppy eyes when anxious. Loyal, loving, and great with people, just not cats. She slept every night with the unicorn stuffy I got her from Canada, I think it reminded her of me. The unicorn kept her company until the very end. I wasn't there to say goodbye but I know she knew how much she was loved. We'll meet again soon Tan!`}</p>
      </div>
...
function Button8() {
  return (
    <div className="bg-white h-full min-h-[36px] relative rounded-[10px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#e8ddd0] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="flex flex-row items-center min-h-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center min-h-[inherit] px-[15px] py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#374151] text-[12px] text-center whitespace-nowrap">🔗 Share memorial</p>
        </div>
      </div>
    </div>
  );
...
function Container48() {
  return (
    <div className="h-[47.998px] relative shrink-0 w-[372.014px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-end pt-[12px] relative size-full">
        <Button8 />
      </div>
    </div>
  );
...
function Button9() {
  return (
    <div className="absolute h-[43.993px] left-[284.51px] top-0 w-[87.509px]" data-name="Button">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] left-[44.49px] not-italic text-[#2a6b4a] text-[11px] text-center top-[13.86px] whitespace-nowrap">See translation</p>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="h-[43.993px] relative shrink-0 w-[372.014px]" data-name="Container">
      <Button9 />
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[82.023px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#6b7280] text-[12px] top-[0.67px] whitespace-nowrap">Tribute Seeds:</p>
      </div>
    </div>
  );
}
...
function Container53() {
  return <div className="bg-[#2a6b4a] relative rounded-[3.997px] shrink-0 size-[7.995px]" data-name="Container" />;
}
...
function Text5() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[35.208px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold leading-[18px] left-0 not-italic text-[#111827] text-[12px] top-[0.67px] whitespace-nowrap">5/5 ⚡</p>
      </div>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[372.014px]" data-name="Container">
      <Container51 />
    </div>
  );
}
...
function Container62() {
  return (
    <div className="h-[30px] relative shrink-0 w-[101.571px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[30px] left-[50.86px] not-italic text-[#111827] text-[20px] text-center top-[-0.22px] whitespace-nowrap">1</p>
      </div>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col items-start left-0 px-[8.556px] py-[12.556px] rounded-[14px] top-0" data-name="Container">
      <div aria-hidden className="absolute border-[#f5f0e8] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <Container60 />
      <ContainerMargin5 />
      <Container62 />
    </div>
...
function Container66() {
  return (
    <div className="h-[30px] relative shrink-0 w-[101.571px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[30px] left-[50.86px] not-italic text-[#111827] text-[20px] text-center top-[-0.22px] whitespace-nowrap">3</p>
      </div>
    </div>
  );
}
...
function Container70() {
  return (
    <div className="h-[30px] relative shrink-0 w-[101.571px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[30px] left-[51.36px] not-italic text-[#111827] text-[20px] text-center top-[-0.22px] whitespace-nowrap">2</p>
      </div>
    </div>
  );
}
...
function ContainerMargin4() {
  return (
    <div className="relative shrink-0 w-[372.014px]" data-name="Container (margin)">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[10px] relative size-full">
        <Container58 />
      </div>
    </div>
...
function Container37() {
  return (
    <div className="bg-white h-[773.012px] max-h-[975.2000122070312px] max-w-[420px] relative rounded-[24px] shrink-0 w-[420px]" data-name="Container">
...
export default function KindredTailsMemorial() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Kindred Tails - Memorial">
      <App />
      <PetModal />
    </div>
  );
