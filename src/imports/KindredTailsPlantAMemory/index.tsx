import svgPaths from "./svg-dphn1yxyo1";
...
function Button1() {
  return (
    <div className="absolute bg-white border border-[#e8ddd0] border-solid h-[48px] left-0 rounded-[14px] top-[0.24px] w-[331px]" data-name="Button">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Bold','Noto_Sans:Bold','Noto_Sans_Math:Regular','Noto_Sans_Symbols:Bold','Noto_Sans_Symbols2:Regular',sans-serif] font-bold leading-[22.5px] left-[164.63px] not-italic text-[#2d2a26] text-[15px] text-center top-[10.08px] tracking-[0.15px] whitespace-nowrap">✕ Close</p>
    </div>
  );
}
