import svgPaths from "./svg-i7a9wo24xl";
...
function Button1() {
  return (
    <div className="absolute content-stretch drop-shadow-[0px_4px_10px_rgba(6,182,212,0.4)] flex h-[44.991px] items-center left-[20px] min-h-[44px] px-[20px] py-[12px] rounded-[50px] top-[20px]" style={{ backgroundImage: "linear-gradient(164.659deg, rgb(6, 182, 212) 0%, rgb(59, 130, 246) 100%)" }} data-name="Button">
...
function Color() {
  return (
    <div className="absolute inset-[23.11%_23.63%_23.96%_26.86%]" data-name="color">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 39.6066 42.3455">
        <g id="color">
          <path d={svgPaths.p34d0f880} fill="var(--fill-0, #B1CC33)" id="Vector" />
          <path d={svgPaths.p319ed900} fill="var(--fill-0, #5C9E31)" id="Vector_2" />
          <path d={svgPaths.p13853000} fill="var(--fill-0, #B1CC33)" id="Vector_3" />
          <path d={svgPaths.ped800} fill="var(--fill-0, #5C9E31)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function Line() {
  return (
    <div className="absolute inset-[23.11%_23.63%_18.94%_26.86%]" data-name="line">
      <div className="absolute inset-[-2.16%_-2.53%_-2.16%_-2.52%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 41.6067 48.3589">
          <g id="line">
            <path d={svgPaths.p30de4900} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            <path d={svgPaths.pf3bcd80} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            <path d={svgPaths.p2fe7fe00} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            <path d={svgPaths.p26159400} id="Vector_4" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            <path d={svgPaths.p1f62b080} id="Vector_5" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
...
function PlantIllustration() {
  return (
    <div className="bg-[#f5f0e8] content-stretch flex flex-col items-center justify-center relative rounded-[20px] shrink-0 size-[100px]" data-name="Plant Illustration">
      <div className="overflow-clip relative shrink-0 size-[80px]" data-name="Icon/Onboarding/Plant">
        <Color />
        <Line />
      </div>
    </div>
...
function Container8() {
  return (
    <div className="h-[25.998px] relative shrink-0 w-[184.01px]" data-name="Container">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[26px] left-[92px] not-italic text-[#111827] text-[20px] text-center top-[-0.44px] tracking-[-0.4492px] whitespace-nowrap">Plant their memory</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="h-[67.188px] relative shrink-0 w-[336.007px]" data-name="Container">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] left-[168.5px] not-italic text-[#5a4a3a] text-[14px] text-center top-[0.78px] tracking-[-0.1504px] w-[337px]">{`Add your pet's name, story, and a photo. A glowing light appears on the map — visible to the whole world, forever.`}</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#2a6b4a] h-[48.49px] relative rounded-[12px] shrink-0 w-[336.007px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold leading-[22.5px] left-[168.09px] not-italic text-[14px] text-center text-white top-[12.22px] tracking-[-0.2344px] whitespace-nowrap">Continue →</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="bg-white drop-shadow-[0px_8px_16px_rgba(0,0,0,0.08)] max-w-[400px] relative rounded-[24px] shrink-0 size-[400px]" data-name="Container">
...
function Container6() {
  return (
    <div className="absolute bg-[#faf8f5] h-[1060px] left-0 top-0 w-[1521.111px]" data-name="Container">
...
export default function KindredTailsOnboarding() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Kindred Tails - Onboarding 1">
      <Body />
      <Container6 />
    </div>
  );
